...
- remote projection safety: queue payloads and approval items pass through structured secret redaction before leaving the control plane; removing a claim token alone is not treated as sufficient isolation;
