...
- capacity-aware external workers: heartbeats may advertise a bounded concurrent-task capacity; remote checkout enforces that limit atomically, reports active/available slots, and leaves legacy workers unlimited when they do not declare one;
