...
Critic output is normalized before it becomes a gate: a review that says `proceed` while listing unresolved `requiredChecks` is downgraded to `revise`, so unresolved verification cannot disappear between cycles.
