...
- role performance reviews: durable lane reports are scored for completion, evidence density, confidence, and process quality; a role cannot become trusted from self-reported process quality without at least one durable evidence anchor per assignment; reviews feed the next research context and never pretend to attribute the final task metric to one agent;
