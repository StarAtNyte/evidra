...
- deadline-aware queue leases: `evidra queue deadline <id> <timestamp|none>` prevents expired work from being claimed and causes cooperative local workers to abort at the deadline;
