...
- handoff outcomes: when a specialist consumes a directive, its completed or failed outcome is tied back to the original handoff ID and exposed in CLI/TUI/dashboard history, so coordination does not end at “message delivered”;
