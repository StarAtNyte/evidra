...
- remote specialist steering: bearer-authenticated `POST /agents/:role/message` queues a bounded, optionally phase-scoped directive for delivery at the next safe role boundary; it cannot expand role authority or bypass admission;
