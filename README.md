...
- **Typed change review.** The director can request a bounded `git.diff` observation for implementation and recovery review; it is read-only, provenance-traced, and treated as untrusted workspace data rather than executable instructions.
