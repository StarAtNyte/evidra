...
- **Recurring-failure circuit breaker.** Three consecutive routine failures pause the schedule, preserve the failure streak, and require an explicit operator resume instead of silently spending an unbounded campaign budget.
