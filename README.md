...
- **Schedule recovery visibility.** Expired routine leases and failed recurring campaigns appear in the same operator attention and health projection as failed tasks and stale agents, even when the routine daemon is offline.
