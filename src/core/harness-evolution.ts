...
export function planHarnessInterventions(input: {
  ...
  add("sandbox", 9, [/executor|execution|process|permissions|recovery/], "sandbox preflight and alternate-executor routing will reduce launcher-boundary failures", "the same sandbox failure recurs without a route change", "the controller classifies the boundary before worker launch and records a verified alternate route");
